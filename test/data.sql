...
INSERT INTO `user` (`id`,`nickname`,`username`,`password`,`deleted`,`first_access_dt`,`last_access_dt`,`verified_dt`,`payment_provider`,`payment_account`,`payment_type`,`country_code`,`language`,`reg_program_id`,`reg_website_id`,`reg_promotor_id`,`reg_promotor_info`,`payments_successful`,`allow_free_minutes`,`received_free_minutes`,`custom`,`tintel_session_id`,`session_count`,`payment_pending`) VALUES (124,NULL,        'fortress-test+changepass@ratus.nl','keeshond',0,'2014-01-01 07:00:00','2014-01-01 07:00:00','2014-01-01 07:00:00','tintel','987','wallet','NL','NL',2473,180,NULL,NULL,NULL,0,0,NULL,NULL,0,NULL);
INSERT INTO `user` (`id`,`nickname`,`username`,`password`,`deleted`,`first_access_dt`,`last_access_dt`,`verified_dt`,`payment_provider`,`payment_account`,`payment_type`,`country_code`,`language`,`reg_program_id`,`reg_website_id`,`reg_promotor_id`,`reg_promotor_info`,`payments_successful`,`allow_free_minutes`,`received_free_minutes`,`custom`,`tintel_session_id`,`session_count`,`payment_pending`) VALUES (125,NULL,        'fortress-test+fiftycent@ratus.nl','keeshond',0,'2014-01-01 07:00:00','2014-01-01 07:00:00','2014-01-01 07:00:00','tintel','987','wallet','NL','NL',2473,180,NULL,NULL,NULL,0,0,NULL,NULL,0,NULL);
INSERT INTO `user` (`id`,`nickname`,`username`,`password`,`deleted`,`first_access_dt`,`last_access_dt`,`verified_dt`,`payment_provider`,`payment_account`,`payment_type`,`country_code`,`language`,`reg_program_id`,`reg_website_id`,`reg_promotor_id`,`reg_promotor_info`,`payments_successful`,`allow_free_minutes`,`received_free_minutes`,`custom`,`tintel_session_id`,`session_count`,`payment_pending`) VALUES (126,NULL,        'fortress-test+program-id@ratus.nl','keeshond',0,'2014-01-01 07:00:00','2014-01-01 07:00:00','2014-01-01 07:00:00','tintel','987','wallet','NL','NL',9182,180,NULL,NULL,NULL,0,0,NULL,NULL,0,NULL);
...
INSERT INTO `user_client` (`id`,`state`,`activity_dt`,`camback_status`,`last_client_state`,`payment_session_id`,`current_domain`,`available_credits`,`pending_snapshots`,`session_data`,`payment_id`,`partner_code`,`device`) VALUES (124,'offline',NULL,'off','connecting','abc','islive-test.io',1956,0,'baz','xyz','316','other');
INSERT INTO `user_client` (`id`,`state`,`activity_dt`,`camback_status`,`last_client_state`,`payment_session_id`,`current_domain`,`available_credits`,`pending_snapshots`,`session_data`,`payment_id`,`partner_code`,`device`) VALUES (125,'offline',NULL,'off','connecting','abc','islive-test.io',50,0,'baz','xyz','316','other');
INSERT INTO `user_client` (`id`,`state`,`activity_dt`,`camback_status`,`last_client_state`,`payment_session_id`,`current_domain`,`available_credits`,`pending_snapshots`,`session_data`,`payment_id`,`partner_code`,`device`) VALUES (126,'offline',NULL,'off','connecting','abc','islive-test.io',50,0,'baz','xyz','316','other');
